...
export default function AdminPage() {
  ...
  const checkAdminAccess = async () => {
    ...
    // ตรวจสอบว่าเป็น admin หรือไม่ (ใส่ email admin ตรงนี้)
    if (!session || session.user?.email !== 'pathom.ler@ww.co.th') {
      router.push('/login');
      return;
    }
  };
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ background: '#374151' }}>
                  ...
                  <th style={{ padding: 12, textAlign: 'left', borderBottom: '1px solid #4b5563' }}>อีเมล</th>
                  <th style={{ padding: 12, textAlign: 'left', borderBottom: '1px solid #4b5563' }}>ชื่อ-นามสกุล</th>
                  <th style={{ padding: 12, textAlign: 'left', borderBottom: '1px solid #4b5563' }}>รหัสนักศึกษา</th>
                  <th style={{ padding: 12, textAlign: 'left', borderBottom: '1px solid #4b5563' }}>แผนก</th>
              ...
              <tbody>
                {filteredUsers.map((user) => (
                  <tr key={user.id} style={{ borderBottom: '1px solid #374151' }}>
                    ...
                    <td style={{ padding: 12 }}>{user.student_id}</td>
          ...
          <div style={{ background: '#1f2937', padding: 30, borderRadius: 12, width: 500, maxWidth: '90vw' }}>
            ...
            <form onSubmit={handleAddUser}>
              <div style={{ marginBottom: 15 }}>
                <label style={{ display: 'block', marginBottom: 5, fontSize: 14 }}>อีเมล *</label>
                <input
                  type="email"
                  required
              ...
              <div style={{ marginBottom: 15 }}>
                <label style={{ display: 'block', marginBottom: 5, fontSize: 14 }}>รหัสนักศึกษา *</label>
                <input
                  type="text"
                  required
              ...
              <div style={{ marginBottom: 15 }}>
                <label style={{ display: 'block', marginBottom: 5, fontSize: 14 }}>แผนก</label>
                <input
                  type="text"
              ...
              <div style={{ marginBottom: 15 }}>
                <label style={{ display: 'block', marginBottom: 5, fontSize: 14 }}>ชั้นปี</label>
                <select
              ...
              <div style={{ marginBottom: 15 }}>
                <label style={{ display: 'block', marginBottom: 5, fontSize: 14 }}>เบอร์โทร</label>
                <input
                  type="tel"
              ...
              <div style={{ marginBottom: 20 }}>
                <label style={{ display: 'block', marginBottom: 5, fontSize: 14 }}>รหัสผ่าน *</label>
                <input
                  type="password"
                  required
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ background: '#1f2937', padding: 30, borderRadius: 12, width: 600, maxWidth: '90vw' }}>
            ...
            <div style={{ marginBottom: 15, fontSize: 14, opacity: 0.8 }}>
              รูปแบบ CSV: email,full_name,student_id,department,year_level,phone,password
            </div>
            <div style={{ marginBottom: 15, fontSize: 12, opacity: 0.6, background: '#111827', padding: 10, borderRadius: 4, fontFamily: 'monospace' }}>
              ตัวอย่าง:<br/>
              email,full_name,student_id,department,year_level,phone,password<br/>
              student001@example.com,นาย ทดสอบ ระบบ,STU001,วิศวกรรมคอมพิวเตอร์,3,0812345678,123456
            </div>
            <textarea
              value={csvData}
